...
public class KafkaConfig {
    ...
    public Map<String, Object> consumerConfigs(){
        ...
        map.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringSerializer.class); //define key as String: <"String", Json>
        map.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonSerializer.class);//define value as Json <String, "Json">
